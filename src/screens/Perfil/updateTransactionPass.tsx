...
import { putAppPass, putTransactionPass } from './services/userAPI';
import { ErrorDTO } from '../../types/responseDTO';

const UpdateTransactionPass = () => {
    ...
    const validationMap = (field: string) => {
        switch (field) {
            ...
            case 'confirmPassword':
                ...
                break;
            case 'oldPassword':
                setErrorMsg({ ...errorMsg, oldPassword: transactionPasswordValidator(watch('oldPassword')) });
                break;
            default:
                break;
        }
    ...
    const onSubmit = async (data: FieldValues) => {
        ...
        const response = await putTransactionPass(auth, data.password, data.oldPassword, account.id);
...
export default UpdateTransactionPass;
